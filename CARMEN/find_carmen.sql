...
--Either or tells you what they speak but not sure how specific you will be looking for
...
--SMR  | San Marino 
            ...
            --this VVV is messy and long 
            -- SELECT * FROM country JOIN countrylanguage ON country.code = countrylanguage.countrycode where language='Italian';
...
SELECT * FROM country JOIN city ON country.code = city.countrycode where city.name LIKE 'Serra%' and region='South America';
--Brazil????? My best guess Carmen is a good hider
